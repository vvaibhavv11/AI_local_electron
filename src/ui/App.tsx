...
const handleSubmit = async (content: string, messages: Message[], setMessages: Dispatch<SetStateAction<Message[]>>) => {
    //@ts-ignore
    ...
    return (
        <Layout>
            ...
            <div className="w-full max-w-4xl flex justify-center items-center space-x-4 px-4 mb-8">
                ...
                />
                <InputForm onSubmit={(content) => handleSubmit(content, messages, setMessages)} />
            </div>
